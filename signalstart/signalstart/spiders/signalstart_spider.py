...
class SignalStartSpider(scrapy.Spider):
    ...
    def parse_details(self, response):
        ...
        # Updated xpaths:
        fields['profit']['xpath'] = "//body/div[2]/div[2]/div/div[2]/div/span/div[1]/div[3]/button/div[2]/div[1]"
        fields['leverage'][
    ...
    def parse(self, response):
        ...
        self.driver.find_element(By.XPATH,
                                 value="/html/body/div[3]/div/div/div[2]/div/div[2]/div[3]/div[2]/div[1]/label/select/option[5]").click()
